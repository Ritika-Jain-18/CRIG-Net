...
from common.r2n_bridge import R2NBridge #added
from models.cross_modal.r2n import R2N #r2n import added
...
class UnetCore(nn.Module):
    def __init__(self, config):
        ...
        # self.r2n_bridge = R2NBridge() #bridge created
        # --- Create R2N and load pretrained weights ---
        self.r2n = R2N()

        ckpt_path = "Enter path here"
        state_dict = torch.load(ckpt_path, map_location="cpu")
        self.r2n.load_state_dict(state_dict)

        print("✅ Loaded pretrained R2N weights")

        # --- Create bridge using this R2N ---
        self.r2n_bridge = R2NBridge(self.r2n)
        ...
        # print("🔥 ACTIVE FORWARD =", self.forward.__name__)
    ...
    def forward_without_contour_concat(self, x, condition=None):
        ...
        print("🔹 Encoder output shape:", x.shape) #modified
        # 🔹 INSERT THIS LINE
        x = self.r2n_bridge(x) #bridge inserted
